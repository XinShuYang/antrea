...
// validateDualStackEgressIPs validates the EgressIPs field for dual-stack mode.
// It requires exactly 2 IPs with different IP families (one IPv4 and one IPv6).
